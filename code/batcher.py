...
class Batch(object):
  ...
  def __init__(self, example_list, hps, vocab, batcher):
  ...
  def init_encoder_seq(self, example_list, hps):
    ...
    if hps.pointer_gen:
      ...
      assert self.max_art_oovs < Batcher.MAX_OOVS
...
class Batcher(object):
  ...
  def __init__(self, data_path, vocab, hps, single_pass, train_data_path=None):
    ...
    Args:
      ...
      train_data_path: If not None, use this to load training data.
    """
    ...
    self._stop_decoding_id = vocab.word2id(data.STOP_DECODING)
    ...
    while True:
      if self._hps.mode != 'decode':
        ...
        for b in batches:  # each b is a list of Example objects
          self._batch_queue.put(Batch(b, self._hps, self._vocab, self))
  ...
  def text_generator(self, example_generator):
    ...
    while True:
      ...
      if len(article_text)==0: # See https://github.com/abisee/pointer-generator/issues/1
        pass #tf.logging.warning('Found an example with empty article text. Skipping it.')
      else:
